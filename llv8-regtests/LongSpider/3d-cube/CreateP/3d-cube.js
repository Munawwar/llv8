...
function Init(CubeSize) {
  ...
  // create qube
  Q[0] = new foo(-CubeSize,-CubeSize, CubeSize);
  Q[1] = new foo(-CubeSize, CubeSize, CubeSize);
  Q[2] = new foo( CubeSize, CubeSize, CubeSize);
  Q[3] = new foo( CubeSize,-CubeSize, CubeSize);
  Q[4] = new foo(-CubeSize,-CubeSize,-CubeSize);
  Q[5] = new foo(-CubeSize, CubeSize,-CubeSize);
  Q[6] = new foo( CubeSize, CubeSize,-CubeSize);
  Q[7] = new foo( CubeSize,-CubeSize,-CubeSize);
  ...
  for (var i = 0; i < Q.NumPx; i++) foo(0,0,0);
