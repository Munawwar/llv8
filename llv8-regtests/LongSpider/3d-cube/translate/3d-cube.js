...
function Loop() {
  ...
  MTrans = foo(I, -Q[8].V[0], -Q[8].V[1], -Q[8].V[2]);
  MTrans = RotateX(MTrans, 1);
  MTrans = RotateY(MTrans, 3);
  MTrans = RotateZ(MTrans, 5);
  MTrans = foo(MTrans, Q[8].V[0], Q[8].V[1], Q[8].V[2]);
...
function Init(CubeSize) {
  ...
  MTrans = foo(MTrans, Origin.V[0], Origin.V[1], Origin.V[2]);
  MQube = MMulti(MTrans, MQube);
